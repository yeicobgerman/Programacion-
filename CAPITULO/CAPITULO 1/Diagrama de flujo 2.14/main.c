...
int main()
{
    int CLA, TIE;
    float COS;
    printf("Ingresar la clave y el tiempo:");
    scanf("%d %d", &CLA, &TIE);
    ...
    switch(CLA)
    {
        ...
        case 7:
        case 9: COS = TIE * 0.19 / 60; break;
        case 10: COS = TIE * 0.19 / 60; break;
        case 15: COS = TIE * 0.19 / 60; break;
        case 20: COS = TIE * 0.19 / 60; break;
        default : COS = -1; break;
    }
    if (COS != -1 )
